...
lyr = arcpy.mapping.ListLayers(mxd, "DuongOngNuoc", df)[0]
table = arcpy.mapping.ListTableViews(mxd, "DL_LoaiOngNuoc", df)[0]

output = sys.argv[1]

arcpy.AddJoin_management(lyr, "maLoai", table, "maLoai")
arcpy.Statistics_analysis(lyr, output, [["chieudai", "SUM"],["chieudai", "MEAN"],["chieudai", "MAX"],["chieudai", "MIN"]], "DL_LoaiOngNuoc.tenLoai")
